...
public class App {
    ...
    static class Addition { /* used to add user numders together */
        public double calculate(double num1, double num2) {
        return num1 + num2;
    }
}
    static class Subtraction {     /* used to subtract user numders from each other */
        public double calculate(double num1, double num2) {
        return num1 - num2;
    }
}

    static class Multiplication {       /* used to multiply user numders together */
        public double calculate(double num1, double num2) {
        return num1 * num2;
    }
}
    static class Division {      /* used to divide a user numder from another number */
        public double calculate(double num1, double num2) {
        if (num2 == 0) {
