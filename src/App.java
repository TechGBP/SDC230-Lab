...
public class App {
    ...
    public static void main(String[] args) throws Exception { 
        System.out.println();
        System.out.println("Gabriela Balanta - Week 3 - 3.2 Project - Arrays and Lists");
        ...
        Double memVal = null; /* for single integer storage */
        ArrayList<Double> memList = new ArrayList<>(); /* for multiple integer storage */
