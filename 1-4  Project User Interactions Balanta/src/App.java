...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        while(count>2){  /* loops for repeated use */
            ...
            System.out.println("\t1 or + for addition");
            System.out.println("\t2 or - for  subtraction");
            System.out.println("\t3 or * for multiplication");
            System.out.println("\t4 or / for division");
        ...
        if(choice==1 || choice == '+')  /* user choose addition */
            {
        ...
        if(choice==2 || choice == '-') /* user choose subtraction */
            {
        ...
        if(choice==3 || choice == '*') /* user choose multiplication */
            {
        ...
        if(choice==4 || choice == '/')   /* user choose division */
            {
